...
**No third-party runtime dependencies** — `pyproject.toml:1-30` declares no runtime requirements; all `[dependency-groups]` are dev/test/docs only (`pyproject.toml:25-54`).
